...
<body>
    ...
    <form class="userprofile_form" method="post" id="frm1" enctype="multipart/form-data" >
    ...
    <div class="userprofile_div">
        <div class="img_div">
	    	<img src="<%=request.getContextPath() %>${user.user_image }" alt="profile" width="200px" height="200px" style="justify-content: center;">
		</div>
        
	    <div class="file-div">
	      <input class="file-input" type="file" name="upload" value="${user.user_image}">
        ...
        <div>
      	...
      	<div class="user_now_pw_div" align="center"> 
        	<input class="now_pw" type="password" value="${user.user_pwd }" name="user_pwd"  placeholder="현재 비밀번호">
        	<span></span>
        </div>
		...
		<div class="phone_div" align="center"> 
            <input class="user_phone" value="${user.user_phone }" name="user_phone" >
        </div>
