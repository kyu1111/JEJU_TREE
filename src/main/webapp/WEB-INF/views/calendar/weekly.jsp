...
.navbar {
margin-top: 15px; /* 원하는 여백 크기를 설정하세요 */
margin-bottom: 15px; /* 원하는 여백 크기를 설정하세요 */
display: flex;
...
calendar.deleteSchedule(eventData.schedule.id, eventData.schedule.calendarId);
 ...
 var event = {
     ...
     isVisible: true,
     dueDateClass: '',
     start: '${plan.start_date}', // 시간 부분을 실제 데이터에 맞게 수정해야 합니다.
     end: '${plan.end_date}',   // 시간 부분을 실제 데이터에 맞게 수정해야 합니다.
    // isReadOnly: true  
 };
 events.push(event);
</c:forEach>
