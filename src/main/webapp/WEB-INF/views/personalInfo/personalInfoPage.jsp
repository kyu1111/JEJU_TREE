...
<html>
<head>
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/personalInfo/personalInfo.css"> 
<meta charset="UTF-8">
...
<body>
	<div class="container">
            ...
            <div class="contents">
                <br>
                ㈜ 제주트리 (' jeju tree, 제주트리, jeju tree.co.kr, jeju tree app' 이하
                ...
                개인정보를 활용합니다. <br>법령 및 제주트리 이용약관을 위반하는
                ...
                <table border="1" cellspacing="0">
                    <thead>
                        <tr>
                            <th class="personal-table-th">목적</th>
                            <th class="personal-table-th">구분</th>
                            <th class="personal-table-th">항목</th>
                            <th class="personal-table-th">용도</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td rowspan="4" class="personal-table-td">회원가입</td>
                            <td class="personal-table-td">회원가입</td>
                            <td class="personal-table-td">[필수]이름, 이메일, 닉네임, 비밀번호</td>
                            <td class="personal-table-td">
                        ...
                        <tr>
                            <td class="personal-table-td">네이버 간편가입</td>
                            <td class="personal-table-td">
                        ...
                        <tr>
                            <td class="personal-table-td">카카오 간편가입</td>
                            <td class="personal-table-td">
                                [필수]이름, 이메일(아이디), 닉네임, 프로필 사진
                                / [선택]성별, 연령대, 생년월일
                            </td>
                        ...
                        <tr>
                            <td class="personal-table-td">구글 간편가입</td>
                            <td class="personal-table-td">
                        ...
                        <tr>
                            <td rowspan="2" class="personal-table-td">회원공통</td>
                            <td class="personal-table-td">자동수집</td>
                            <td class="personal-table-td">
                        ...
                        <tr>
                            <td class="personal-table-td">선택수집</td>
                            <td class="personal-table-td">휴대전화번호, 이메일 주소</td>
                            <td class="personal-table-td">이벤트 및 신규서비스 안내, 마케팅</td>
                        </tr>
                        <tr>
                            <td class="personal-table-td">구매회원</td>
                            <td class="personal-table-td">결제</td>
                            <td class="personal-table-td">
                ...
                <br>
                <br>• 개인정보 보호책임자 <br>성명 : 도수경 <br>직책 : CTO
                <br>연락처 : contact@jeju tree.co.kr
                <br>
                <br>• 개인정보 보호 담당부서 <br>부서명 : 개발팀
                <br>담당자 : 도수경 <br>연락처 : contact@jeju tree.co.kr
                <br>
                <br>■ 정보주체께서는 "회사"의 서비스('jeju tree.co.kr, jeju tree app',
                ...
                <br>• 공고일자: 2022년 11월 11일 <br>• 시행일자: 2022년 11월
                19일<br>
                <br>
                <br>
            </div>
            <div>
                <h6>&copy JEJU TREE co.,Ltd. All Rights reserved.</h6>
            </div>
        </div>
</body>
</html>